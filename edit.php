...
<label class="flex items-center gap-2 bg-[#7c6cff]/5 border border-[#7c6cff]/20 p-3 rounded-xl text-sm cursor-pointer"><input type="checkbox" name="promo_1_1" value="1" <?php echo intval($r['promo_count'])==2?'checked':''; ?> class="w-5 h-5 accent-[#7c6cff]"><span>🎁 1+1 Aksiya — bu nomer <b>2 ta</b> bo'lib hisoblansin</span></label>
